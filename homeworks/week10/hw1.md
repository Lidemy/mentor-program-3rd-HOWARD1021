...
,倒也不是完全不會寫,就是這邊卡,那邊也卡,後來就還是去求助同學的作業,但是,不是自己寫的,成就感就少少的
...
### 複習心得
串接 API 的指令,要仔細看,當初在串 API 的時候,因為少打了一個指令,卡了一陣子,這周再寫的時候一開始有點畏懼,因為在寫 API 那周,還有一些不懂得地方,竟然馬上就要開始用網站串 API 著實感到不踏實,不過,真的開始寫後,卻反而很有成就感,感覺就是不夠熟而已
## 複習第九周 
### 解題心得
...
這周開始 delay 的有點嚴重,新的 php sql ,相較比較大量的課綱要讀,但是也是很有趣,很充實滿滿的內容,
在寫後端的時候給我的感覺像是當一個精明能幹的秘書,要整理好老闆給的文件,逐一分類,每份文件有或多或少的相關性,
然後用正確的文法,找到老闆所需要的文件,不過在寫得時候開了超級多的分頁去整理,
中間有利用老師教學影片中的方法,把function 統整在一個 utils.php 裡面,程式碼有簡潔許多
## 總結
* 睽違了兩個月 才又來交作業,老師可能都不記得我了QQ(我誰?
* 最近被進度延宕得感受瀰漫全身,
想起了當替代役時,測驗 3000 的時候,因為消防役,分數基本上就是看體能,所以跑步成績占比很重,當時印象很深刻的是,起跑的一開始,全部人都奮力起跑,畫面有點像是賽馬場的馬兒,背負著觀眾的期待,奮力起跑XD,一開始為了跟上大家的速度,我跑的超級快,呼吸都亂掉了, 開跑一圈就喘得,不要不要的,但我做了一個決定,決定不跟其他人的速度,調整呼吸,照自己的步伐,一開始跟別人的距離漸漸被拉開,但跑了幾圈後,我找回了自己的步伐, 最後  第一名 
